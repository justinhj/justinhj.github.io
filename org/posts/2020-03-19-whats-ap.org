...
Next we are show that Applicatives are all Functors (hence Applicative
Functors), because you can implement the map operation as follows...
...
implemented) Scala library: [[https://github.com/sammthomson/IdiomEars][Idiom Ears]]
